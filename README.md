...
Sistem ini berjalan 100% secara serverless memanfaatkan alur kerja GitHub Actions dan GitHub Pages:

+----------------------+       +-------------------------+       +------------------------+
| Satelit SiPongi KLHK | ----> | GitHub Actions (Python) | ----> | Output File Generated  |
+----------------------+       +-------------------------+       | - peta.html            |
                                            ^                    | - stats.json           |
+----------------------+                    |                    | - CSV Data (/data/)    |
| Shapefile Desa & KK  | -------------------+                    +------------------------+
